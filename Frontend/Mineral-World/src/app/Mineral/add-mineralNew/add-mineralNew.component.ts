...
@Component({
  selector: 'app-add-mineralNew',
  templateUrl: './add-mineralNew.component.html',
  styleUrls: ['./add-mineralNew.component.scss']
})
export class AddMineralNewComponent implements OnInit {
 ...
 mineralView: IMineralBase = {
  ...
  constructor(private fb: FormBuilder,
    ...
    private MineralWorldService: MineralWorldService) { }
